...
TRAIN_WHAT_OPTION_ALL = 'Alle'
TRAIN_WHAT_OPTION_ONLY = 'only_train'
...
DECKSTATION_THRESHOLD_ALL = 'Alle'
...
LISTING_HEADER_TRAIN_STATE = 'Trainings-Status'
...
FILTER_PRESETS_TEXT = 'Oder hier eine Vorlage aus der filter_presets-Datei auswählen:'
