...
class HtmlClipboard:
    ...
    DEFAULT_HTML_BODY = "%s"
    # DEFAULT_HTML_BODY="<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.0 Transitional//EN\">" \
...
if __name__ == '__main__':
    ...
    def test_SimpleGetPutHtml():
        ...
        data = "<tr><th>Firstname</th><th>Lastname</th><th>Age</th></tr><tr><td>Jill</td><td>Smith</td><td>50</td></tr>"
        PutHtml(data)
        if GetHtml() == data:
            print("passed")
        else:
